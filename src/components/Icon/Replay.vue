<template>
  <svg :width="size" :height="size" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 305.836 305.836" style="enable-background:new 0 0 305.836 305.836;" xml:space="preserve">
    <g>
      <path d="M152.924,300.748c84.319,0,152.912-68.6,152.912-152.918c0-39.476-15.312-77.231-42.346-105.564
        ...
        C0,232.148,68.602,300.748,152.924,300.748z" :fill="color"/>
    </g>
  </svg>
</template>
